...
INSERT INTO SanPham (MaSP, TenSP, LoaiSP, KT, MS, CL, Gia, SoLuong)
VALUES (1,N'Áo vô tri', N'Áo không cổ', 'L', N'Đỏ', 'Len', 100.00, 10),
	   (2,N'Áo không sợ vợ ', N'Áo Polo', 'M', N'Vàng', 'Nỉ', 199.00, 20);
